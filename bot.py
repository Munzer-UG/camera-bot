...
async def voice_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        with sr.AudioFile(wav_path) as source:
            ...
            # أزرار الترجمة
            keyboard = [
                [InlineKeyboardButton(LANGUAGES[lang], callback_data=f"translate_{lang}") for lang in LANGUAGES]
            ]
            reply_markup = InlineKeyboardMarkup(keyboard)
            await update.message.reply_text("🔄 اختر اللغة المستهدفة:", reply_markup=reply_markup)
